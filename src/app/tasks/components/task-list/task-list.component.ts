  ...
  export class TaskListComponent implements OnInit {
    ...
    handleToggleComplete(taskToUpdate: Task): void {
        this.tasks = this.tasks.map(task => {
          ...
          return {...task, completed: !task.completed}; //nuevo oobjeto con la propiedad 'completed' cambiada 
        }
        return task // devolvemos el objeto original, la tarea sin cambiar el estado
      });
